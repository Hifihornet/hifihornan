        ...
        <div className="prose prose-invert max-w-none space-y-6">
          ...
          <section className="space-y-4">
            ...
            <p className="text-foreground/80">
              Välkommen till Hifihörnan. Genom att använda vår webbplats accepterar du dessa användarvillkor. 
          ...
          <section className="space-y-4">
            ...
            <p className="text-foreground/80">
              Hifihörnan är en marknadsplats som möjliggör för privatpersoner att köpa och sälja 
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-foreground/80">
                  Som användare av Hifihörnan ansvarar du fullt ut för:
                </p>
              ...
              <div>
                <h3 className="text-xl font-medium mb-2">3.2 Hifihörnans roll</h3>
                <p className="text-foreground/80">
                  <strong>Viktigt att förstå:</strong> Hifihörnan är inte part i någon affär som sker mellan 
              ...
              <div>
                ...
                <p className="text-foreground/80">
                  Följande är inte tillåtet på Hifihörnan:
                </p>
                <ul className="list-disc pl-6 text-foreground/80 space-y-2 mt-2">
