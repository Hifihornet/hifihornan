    ...
    >
      <div className="aspect-[4/3] relative overflow-hidden bg-secondary">
        {listing.images && listing.images.length > 0 && listing.images[0] ? (
          <>
            {/* Kontrollera om det är en giltig bild-URL */}
            {listing.images[0].startsWith('blob:') || listing.images[0].startsWith('data:') ? (
              <div className="w-full h-full flex items-center justify-center text-muted-foreground bg-secondary">
                <div className="text-center">
                  <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-2">
                    <div className="w-6 h-6 bg-gray-400 rounded"></div>
                  </div>
                  <p className="text-sm">Bilden kunde inte visas</p>
                  <p className="text-xs text-muted-foreground mt-1">Lokal bild</p>
                </div>
              </div>
            ) : (
              <>
                ...
                />
                {/* Fallback som visas direkt vid fel */}
                <div 
